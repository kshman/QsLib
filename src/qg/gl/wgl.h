 ...
 *
 * Commandline:
 *    --api='wgl=1.0' --extensions='WGL_ARB_extensions_string,WGL_ARB_multisample,WGL_EXT_extensions_string' c --header-only
 *
 * Online:
 *    http://glad.sh/#api=wgl%3D1.0&extensions=WGL_ARB_extensions_string%2CWGL_ARB_multisample%2CWGL_EXT_extensions_string&generator=c&options=HEADER_ONLY
 *
 */
