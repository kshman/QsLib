//
// qgrdh_qglfunc.c - GL 함수
// 2024-01-26 by kim
//

#include "pch.h"
#if (defined USE_ES || defined USE_GL) && !defined _QN_EMSCRIPTEN_ && !defined _QN_ANDROID_
#ifdef _MSC_VER
...
#if defined USE_GL && defined USE_ES
...
static void glad_gl_load_GL_ES_KHR_debug(GLADuserptrloadfunc load, void* userptr) {
	if (!GLAD_GL_KHR_debug) return;
...
int gladLoadGLES2UserPtr(GLADuserptrloadfunc load, void *userptr) {
	...
	glad_gl_load_GL_ES_KHR_debug(load, userptr);
...
#endif // (USE_ES || USE_GL) && !_QN_EMSCRIPTEN_ && !_QN_ANDROID_
