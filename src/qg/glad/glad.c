/*
    ...
    OpenGL ES loader generated by glad 0.1.36 on Wed Dec 20 07:57:49 2023.
    ...
    Commandline:
        --profile="compatibility" --api="gles1=1.0,gles2=3.0" --generator="c" --spec="gl" --local-files --extensions=""
    Online:
